...
## ⚠️ **IMPORTANT NOTICE**
**This repository is a minimal baseline/framework for Graig Fatha Wind Farm and is WIP**
...
Home Assistant custom componant for Graig Fatha Wind Farm based on the JSON the dashboard returns.
